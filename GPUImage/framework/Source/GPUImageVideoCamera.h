...
//@property(readwrite) BOOL sessionSyncAudioEncoding;
@property(readonly, retain, nonatomic) AVCaptureDeviceInput *sessionVideoInput;
@property(readonly, retain, nonatomic) AVCaptureDeviceInput *sessionAudioInput;
@property(readonly, retain, nonatomic) AVCaptureVideoDataOutput *sessionVideoOutput;
@property(readonly, retain, nonatomic) AVCaptureAudioDataOutput *sessionAudioOutput;
