...
//*********************** extension for awesomevisual begin
//@synthesize sessionSyncAudioEncoding = addedAudioInputsDueToEncodingTarget;
@synthesize sessionVideoInput = videoInput;
@synthesize sessionAudioInput = audioInput;
@synthesize sessionVideoOutput = videoOutput;
@synthesize sessionAudioOutput = audioOutput;
//*********************** extension for awesomevisual end
...
{
    NSArray* copyTarget = targets.copy;
    NSArray* copyTextureTarget = targetTextureIndices.copy;
    
    // First, update all the framebuffers in the targets
    for (id<GPUImageInput> currentTarget in /*targets*/copyTarget)
    {
        if ([currentTarget enabled])
        {
            NSInteger indexOfObject = [/*targets*/copyTarget indexOfObject:currentTarget];
            NSInteger textureIndexOfTarget = [[/*targetTextureIndices*/copyTextureTarget objectAtIndex:indexOfObject] integerValue];
